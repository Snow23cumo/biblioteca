...
Route::post('ajax-sesion','AjaxController@setSesion')->name('ajax')->middleware('auth');
Route::group(['prefix' => 'admin', 'namespace' => 'Admin', 'middleware' => ['auth','superadmin']], function () {
 ...
 Route::post('libro/{id}', 'LibroController@ver')->name('ver_libro');
